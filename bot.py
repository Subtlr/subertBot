...
import os
from dotenv import load_dotenv # Only imports this function.
...
TOKEN = os.getenv("DISCORD_TOKEN") # From the os, get the discord token from the .env file

client = MyClient(intents=intents) # From a class in the program to the client, this connects the dots.
client.run(TOKEN)  # This runs it to the correct bot.